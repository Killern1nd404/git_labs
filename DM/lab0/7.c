...
int check_is_a_and_b_not_intersected(const int a_len, const int *array_a, const int b_len, const int *array_b) {
...
int main() {
    ...
    bool is_a_in_b = check_is_a_and_b_not_intersected(a_len, array_a, b_len, array_b);
