...
bool check_is_a_same_b(const int a_len, const int *array_a, const int b_len, const int *array_b) {
    if (a_len != b_len) {
        return false;
    }
...
int main() {
    ...
    bool is_a_in_b = check_is_a_same_b(a_len, array_a, b_len, array_b);
