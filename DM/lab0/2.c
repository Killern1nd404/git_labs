...
int arrays_intersection(const int a_len, const int *array_a, const int b_len, const int *array_b, int *c_len, int *array_c) {
...
int main() {
    ...
    arrays_intersection(a_len, array_a, b_len, array_b, &c_len, array_c);
